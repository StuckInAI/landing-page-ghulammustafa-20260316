...
const footerLinks = {
  ...
  Support: ['Help Center', 'Community', 'Status Page', 'Integrations'],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-5">
              ...
              <span className="text-xl font-extrabold text-white">LaunchPad</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-xs">
              The all-in-one platform for modern teams to build, collaborate, and ship
        ...
        <div className="border-t border-gray-800 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} LaunchPad, Inc. All rights reserved.
          </p>
